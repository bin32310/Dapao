            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="${pageContext.request.contextPath }/resources/logo/back.png" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">관리자</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="${pageContext.request.contextPath }/resources/logo/back.png" class="img-circle" alt="User Image" />
                    <p>관리자</p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
